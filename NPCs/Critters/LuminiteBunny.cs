...
namespace TheCollectors.NPCs.Critters
{
	public class LuminiteBunny : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			NPC.aiStyle = 7;
			NPC.catchItem = (short)ModContent.ItemType<Items.Consumables.Critters.LuminiteBunnyItem>();
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			...
			if (!Main.dedServ)
			{
				...
				Gore.NewGore(NPC.GetSource_Death(), pos, NPC.velocity, ModContent.Find<ModGore>("TheCollectors/LuminiteBunnyGore1").Type);

				pos = NPC.position + new Vector2(Main.rand.Next(NPC.width - 8), Main.rand.Next(NPC.height / 2));
				Gore.NewGore(NPC.GetSource_Death(), pos, NPC.velocity, ModContent.Find<ModGore>("TheCollectors/LuminiteBunnyGore2").Type);
			}
		}
