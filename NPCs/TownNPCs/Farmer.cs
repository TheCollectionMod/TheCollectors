...
{
    public class FarmerProfile : ITownNPCProfile
    {
        ...
        public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
        {
            if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
                ...
                return ModContent.Request<Texture2D>("TheCollectors/NPCs/TownNPCs/Farmer");

            if (npc.altTexture == 1)

                return ModContent.Request<Texture2D>("TheCollectors/NPCs/TownNPCs/Farmer_Party");

            return ModContent.Request<Texture2D>("TheCollectors/NPCs/TownNPCs/Farmer");
        }
        public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("TheCollectors/NPCs/TownNPCs/Farmer_Head");
    }
    [AutoloadHead]
    ...
    public class Farmer : ModNPC
    {
        ...
        public override string Texture => "TheCollectors/NPCs/TownNPCs/Farmer";
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Mods.TheCollectors.Bestiary.Farmer")
            });
        }
        public override bool CanTownNPCSpawn(int numTownNPCs, int money)
        {
            if (TheCollectorsWorld.savedFarmer && NPC.CountNPCS(ModContent.NPCType<Farmer>()) < 1)
            {
                return true;
            }
            return false;
        ...
        {
            shop.item[nextSlot].SetDefaults(ItemID.Sunflower); nextSlot++;
        }
        public override string GetChat()
        {
            return Language.GetTextValue("Mods.TheCollectors.Dialogue.Farmer.TemporalDialogue");
        }
