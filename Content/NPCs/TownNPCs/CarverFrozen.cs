...
{
	public class CarverFrozen : ModNPC
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Carver Frozen");
		...
		public override string GetChat()
		{
			...
			chat.Add(Language.GetTextValue("Mods.TheCollectors.Dialogue.CarverFrozen.RescueDialogue"));
		...
		{
			NPC.Transform(NPCType<Carver>());
			NPC.dontTakeDamage = false;
			TheCollectorsWorld.savedCarver = true;
			TheCollectorsWorld.UpdateWorldBool();
			TheCollectorsWorld.CarverJustRescued = true;
		}
		public override float SpawnChance(NPCSpawnInfo spawnInfo) //from Rijam's Mod
		{
			if (spawnInfo.Player.ZoneSnow && !TheCollectorsWorld.savedCarver && !NPC.AnyNPCs(ModContent.NPCType<CarverFrozen>()) && !NPC.AnyNPCs(ModContent.NPCType<Carver>()))
			{
