...
{
	public class LuminiteSquirrel : ModNPC
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Luminite Squirrel");
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Mods.TheCollectors.Bestiary.LuminiteSquirrel")
			});
		}
		public override void SetDefaults()
		{
			...
			NPC.aiStyle = 7;
			NPC.catchItem = (short)ModContent.ItemType<Content.Items.Consumables.Critters.LuminiteSquirrelItem>();
