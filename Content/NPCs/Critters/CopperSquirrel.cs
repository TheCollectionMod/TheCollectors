...
{
	public class CopperSquirrel : ModNPC
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Copper Squirrel");
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Mods.TheCollectors.Bestiary.CopperSquirrel")
			});
		}
		public override void SetDefaults()
		{
			...
			NPC.aiStyle = 7;
			NPC.catchItem = (short)ModContent.ItemType<Content.Items.Consumables.Critters.CopperSquirrelItem>();
