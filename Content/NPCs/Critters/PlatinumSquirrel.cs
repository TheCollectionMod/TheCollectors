...
{
	public class PlatinumSquirrel : ModNPC
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Platinum Squirrel");
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Mods.TheCollectors.Bestiary.PlatinumSquirrel")
			});
		}
		public override void SetDefaults()
		{
			...
			NPC.aiStyle = 7;
			NPC.catchItem = (short)ModContent.ItemType<Content.Items.Consumables.Critters.PlatinumSquirrelItem>();
