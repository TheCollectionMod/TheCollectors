using TheCollectors.Common.Systems;
using TheCollectors.Content.BossBars;
using TheCollectors.Content.Items.Armor.Vanity;
using TheCollectors.Content.Items;
using TheCollectors.Content.Items.Consumables.Bosses;
using TheCollectors.Content.Items.Placeable.Bosses;
using TheCollectors.Content.Pets.MinionBossPet;
using TheCollectors.Content.Projectiles.Bosses;
...
namespace TheCollectors.Content.NPCs.Bosses.TCMeteorBoss
{
	// The main part of the boss, usually refered to as "body"
	[AutoloadBossHead] // This attribute looks for a texture called "ClassName_Head_Boss" and automatically registers it as the NPC boss head icon
	public class TCMeteorBossBody : ModNPC
	{
		...
		{
			return ModContent.NPCType<TCMeteorBossMinion>();
		}
		...
		public override void SetStaticDefaults()
		{
			...
			{
				CustomTexturePath = "TheCollectors/Assets/Textures/Bestiary/TCMeteorBoss_Preview",
		...
		public override void ModifyNPCLoot(NPCLoot npcLoot)
		{
			...
			npcLoot.Add(ItemDropRule.BossBag(ModContent.ItemType<TCMeteorBossBag>()));

			// Trophies are spawned with 1/10 chance
			npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Content.Items.Placeable.Bosses.TCMeteorBossTrophy>(), 10));

			// ItemDropRule.MasterModeCommonDrop for the relic
			npcLoot.Add(ItemDropRule.MasterModeCommonDrop(ModContent.ItemType<Content.Items.Placeable.Bosses.TCMeteorBossRelic>()));
			...
			int itemType = ModContent.ItemType<Content.Items.NPCStash.McMoneyPants.TerraCoin>();
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			...
			if (NPC.life <= 0)
			{
				...
				int backGoreType = Mod.Find<ModGore>("TCMeteorBossBody_Back").Type;
				int frontGoreType = Mod.Find<ModGore>("TCMeteorBossBody_Front").Type;
		...
		private void SpawnMinions()
		{
			...
			{
				NPC minionNPC = NPC.NewNPCDirect(entitySource, (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<TCMeteorBossMinion>(), NPC.whoAmI);
				...
				TCMeteorBossMinion minion = (TCMeteorBossMinion)minionNPC.ModNPC;
		...
		private void CheckSecondStage()
		{
			...
			for (int i = 0; i < Main.maxNPCs; i++)
			{
				...
				if (otherNPC.active && otherNPC.type == MinionType() && otherNPC.ModNPC is TCMeteorBossMinion minion)
				{
