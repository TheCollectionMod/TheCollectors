...
public class Eyeling : ModNPC 
    ...
    public override void SetDefaults()
    {
        ...
        Banner = NPC.type;
        BannerItem = ModContent.ItemType<Content.Items.Placeable.Banners.EyelingBanner>();
    }
    ...
    public override void ModifyNPCLoot(NPCLoot npcLoot) 
    {
        ...
        npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Pets.FlyingEyeling.FlyingEyelingItem>(), 100)); 
    }
