...
namespace TheCollectors.Content.Projectiles
{
	...
	public class MeteoriteFlailProjectile : ModProjectile
	{
		private const string ChainTexturePath = "TheCollectors/Content/Projectiles/MeteoriteFlailProjectileChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "TheCollectors/Content/Projectiles/MeteoriteFlailProjectileChainExtra";  // This texture and related code is optional and used for a unique effect
		...
		{
			// DisplayName.SetDefault("Meteorite Flail");
		...
		public override void AI()
		{
			...
			if (Main.rand.NextBool(dustRate))
				Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<Flame>(), 0f, 0f, 150, new Color(253, 178, 49), 1.3f);
		}
