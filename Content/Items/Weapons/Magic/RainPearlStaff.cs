...
{
	public class RainPearlStaff : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Pearl Rain Staff");
			Tooltip.SetDefault("Summons a rain of pearls to strike your enemies!");
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<PearlRain>();
		}
	}
}*/