...
{
	public class SapphireStaffTier1 : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Freezing Sapphire Staff");
		...
		public override void SetDefaults()
		{
			...
			//Use Properties
			Item.useTime = 33; //Total time that the item will take
			Item.useAnimation = 33; //Total time that the animation of the item will take
			Item.autoReuse = true;
			...
			//Weapon Properties
			Item.damage = 28; // Base Staff 18
			Item.mana = 9;
			Item.crit = 1; //le suma 1% al base
			Item.shootSpeed = 8.5f; //Velocity of projectile
			Item.shoot = ModContent.ProjectileType<SapphireBoltTier1>();
		}
	}
}