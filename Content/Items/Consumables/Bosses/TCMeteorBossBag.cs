...
using TheCollectors.Content.NPCs.Bosses.TCMeteorBoss;
...
namespace TheCollectors.Content.Items.Consumables.Bosses
{
	// Basic code for a boss treasure bag
	public class TCMeteorBossBag : ModItem
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot)
		{
			...
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<TerraCoin>(), 1, 12, 16));
			itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<TCMeteorBossBody>()));
		}
