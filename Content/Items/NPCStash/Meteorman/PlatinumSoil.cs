...
{
	public class PlatinumSoil : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Items.NPCStash.Meteorman.PlatinumSoilTile>();
	...
	public class PlatinumSoilTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			//ItemDrop = ModContent.ItemType<Content.Items.NPCStash.Meteorman.PlatinumSoil>();
