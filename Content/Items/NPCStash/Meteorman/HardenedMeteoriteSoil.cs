...
namespace TheCollectors.Content.Items.NPCStash.Meteorman
{
	public class HardenedMeteoriteSoil : ModItem
	{
		...
		public override void ExtractinatorUse(int extractinatorBlockType, ref int resultType, ref int resultStack)
		{
			int[] soil = new int[]
			{
				ModContent.ItemType<Content.Items.Placeable.RefinedMeteoriteSet.HardenedMeteoriteOre>(),
				ItemID.MudBlock,
				ItemID.SlushBlock,
				ItemID.DirtBlock,
				ItemID.SiltBlock,
	...
	public class HardenedMeteoriteSoilTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			//ItemDrop = ModContent.ItemType<Content.Items.NPCStash.Meteorman.HardenedMeteoriteSoil>();
