...
namespace TheCollectors.Content.Buffs
{
	...
	public class RefinedMeteoriteMinecartBuff : ModBuff
	{
		...
		public override LocalizedText DisplayName => ModContent.GetInstance<RefinedMeteoriteMinecartItem>().DisplayName;
		...
		public override void SetStaticDefaults() {
			...
			BuffID.Sets.BasicMountData[Type] = new BuffID.Sets.BuffMountData() {
				mountID = ModContent.MountType<RefinedMeteoriteMinecartMount>()
			};
		}
	}
}
