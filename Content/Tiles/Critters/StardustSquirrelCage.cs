...
namespace TheCollectors.Content.Tiles.Critters
{
	public class StardustSquirrelCage : ModItem
	{
		...
		{
			// DisplayName.SetDefault("Stardust Squirrel Cage");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<Content.Items.Consumables.Critters.StardustSquirrelItem>(), 1);
	...
	public class StardustSquirrelCageTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// name.SetDefault("Stardust Squirrel Cage");
			AddMapEntry(new Color(200, 200, 200), name);
		}
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 32, ModContent.ItemType<StardustSquirrelCage>());
		}
