...
namespace TheCollectors.Content.Tiles.Critters
{
    public class HardenedMeteoriteBunnyCage : ModItem
    {
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<HardenedMeteoriteBunnyItem>(), 1)
    ...
    public class HardenedMeteoriteBunnyCageTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(122, 217, 232), ModContent.GetInstance<HardenedMeteoriteBunnyCage>().DisplayName);
        }
