...
namespace TheCollectors.Content.Tiles.Critters
{
    public class SturdyFossilSquirrelCage : ModItem
    {
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<SturdyFossilSquirrelItem>(), 1)
    ...
    public class SturdyFossilSquirrelCageTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(122, 217, 232), ModContent.GetInstance<SturdyFossilSquirrelCage>().DisplayName);
        }
