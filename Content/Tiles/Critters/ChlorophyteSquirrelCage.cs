...
namespace TheCollectors.Content.Tiles.Critters
{
    public class ChlorophyteSquirrelCage : ModItem
    {
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<ChlorophyteSquirrelItem>(), 1)
    ...
    public class ChlorophyteSquirrelCageTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(122, 217, 232), ModContent.GetInstance<ChlorophyteSquirrelCage>().DisplayName);
        }
