...
{
	public class LuminiteBunnyCage : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Luminite Bunny Cage");
		}
		public override void SetDefaults()
		{
			Item.CloneDefaults(ItemID.AmberBunnyCage);
			Item.createTile = ModContent.TileType<LuminiteBunnyCageTile>();
		}
		public override void AddRecipes()
		{
			Recipe recipe = CreateRecipe();
			recipe.AddIngredient(ModContent.ItemType<Content.Items.Consumables.Critters.LuminiteBunnyItem>(), 1);
			recipe.AddIngredient(ItemID.Terrarium, 1);
			recipe.AddTile(TileID.WorkBenches);
			recipe.Register();
		}
	}
	public class LuminiteBunnyCageTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// name.SetDefault("Luminite Bunny Cage");
			AddMapEntry(new Color(200, 200, 200), name);
		}
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 32, ModContent.ItemType<LuminiteBunnyCage>());
		}
