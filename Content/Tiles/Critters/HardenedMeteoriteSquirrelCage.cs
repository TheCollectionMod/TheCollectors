...
namespace TheCollectors.Content.Tiles.Critters
{
    public class HardenedMeteoriteSquirrelCage : ModItem
    {
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<HardenedMeteoriteSquirrelItem>(), 1)
    ...
    public class HardenedMeteoriteSquirrelCageTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(122, 217, 232), ModContent.GetInstance<HardenedMeteoriteSquirrelCage>().DisplayName);
        }
