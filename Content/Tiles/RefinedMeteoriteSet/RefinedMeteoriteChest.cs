...
{
	public class RefinedMeteoriteChest : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			RegisterItemDrop(ModContent.ItemType<Content.Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteChest>(), 1);
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<Content.Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteChest>();
