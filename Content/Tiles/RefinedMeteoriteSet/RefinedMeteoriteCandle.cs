...
namespace TheCollectors.Content.Tiles.RefinedMeteoriteSet
{
	...
	internal class RefinedMeteoriteCandle : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			//ItemDrop = ModContent.ItemType<Content.Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteCandle>();
			...
			if (!Main.dedServ)
			{
				flameTexture = ModContent.Request<Texture2D>("TheCollectors/Content/Tiles/RefinedMeteoriteSet/RefinedMeteoriteCandle_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
			}
		}
