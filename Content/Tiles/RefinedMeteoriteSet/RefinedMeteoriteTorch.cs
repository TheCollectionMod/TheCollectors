...
{
	public class RefinedMeteoriteTorch : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			//ItemDrop = ModContent.ItemType<Content.Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteTorch>();
			...
			if (!Main.dedServ)
			{
				flameTexture = ModContent.Request<Texture2D>("TheCollectors/Content/Tiles/RefinedMeteoriteSet/RefinedMeteoriteTorch_Flame");
			}
		}
