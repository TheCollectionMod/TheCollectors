...
{
	internal class RefinedMeteoriteCampfire : ModTile
	{
		public int Timer;
		...
		{
			Terraria.Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 32, ModContent.ItemType<Content.Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteCampfire>());
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Content.Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteCampfire>();
		}
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Texture2D glowmask = ModContent.Request<Texture2D>("TheCollectors/Content/Tiles/RefinedMeteoriteSet/RefinedMeteoriteCampfire_Flame").Value;
			...
			Main.spriteBatch.Draw(glowmask, drawOffset, (Rectangle?)new Rectangle(xPos, yPos, 18, 18), new Color(167, 53, 175, 0), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
		}
...
/*{
	...
	public override void SetStaticDefaults()
	{
		...
		if (!Main.dedServ)
		{
			flameTexture = ModContent.Request<Texture2D>("TheCollectors/Content/Tiles/RefinedMeteoriteSet/RefinedMeteoriteCampfirev2_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
		}
	}

	public override void KillMultiTile(int i, int j, int frameX, int frameY)
	{
		Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32,16, ModContent.ItemType<Content.Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteCampfirev2>());
	}
