...
{
    class SpectreTreeSapling : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.AnchorValidTiles = new[] { ModContent.TileType<Items.NPCStash.Meteorman.SpectreSoilTile>() };
            ...
            // name.SetDefault("Spectre Sapling");
