...
{
    class CopperTreeSapling : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.AnchorValidTiles = new[] { ModContent.TileType<Items.NPCStash.Meteorman.CopperSoilTile>() };
            ...
            // name.SetDefault("Copper Sapling");
