...
{
    class HallowTreeSapling : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.AnchorValidTiles = new[] { ModContent.TileType<Items.NPCStash.Meteorman.HallowedSoilTile>() };
            ...
            // name.SetDefault("Hallow Sapling");
