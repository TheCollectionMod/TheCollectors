...
{
	public class RedCandyCaneBed : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
            ...
            // Etc
            AddMapEntry(new Color(255, 102, 102), Language.GetText("ItemName.Bed"));
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				player.noThrow = 2;
				player.cursorItemIconEnabled = true;
				player.cursorItemIconID = ModContent.ItemType<Items.Placeable.RedCandyCaneSet.RedCandyCaneBed>();
			}
		}
	}
}