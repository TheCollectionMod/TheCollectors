...
namespace TheCollectors.Content.Tiles.Bosses.TCMeteorBoss
{
	...
	public class TCMeteorBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "TheCollectors/Content/Tiles/Bosses/TCMeteorBoss/TCMeteorBossRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "TheCollectors/Content/Tiles/Bosses/RelicPedestal";
