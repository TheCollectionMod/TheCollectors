...
namespace TheCollectors.Backgrounds
{
	public class ExampleSurfaceBackgroundStyle : ModSurfaceBackgroundStyle
	{
		...
		public override int ChooseMiddleTexture()
		{
			...
			switch (SurfaceFrame)
			{
				...
				case 3:
					return BackgroundTextureLoader.GetBackgroundSlot("TheCollectors/Assets/Textures/Backgrounds/ExampleBiomeSurfaceMid3"); // You can use the full path version of GetBackgroundSlot too
				default:
					return -1;
			}
		}
