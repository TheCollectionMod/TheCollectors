...
namespace TheCollectors.Content.Biomes
{
	public class ExampleUndergroundBiome : ModBiome
	{
		...
		public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.Find<ModUndergroundBackgroundStyle>("TheCollectors/ExampleUndergroundBackgroundStyle");
