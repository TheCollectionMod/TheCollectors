...
namespace TheCollectors.Buffs
{
	...
	public class Thunder : ModBuff
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Thunder debuff"); // Buff display name
		...
		{
			player.GetModPlayer<ThunderDebuffPlayer>().lifeRegenDebuff = true;
		}
	}

	public class ThunderDebuffPlayer : ModPlayer
	{
