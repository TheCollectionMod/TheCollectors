...
namespace TheCollectors.Buffs
{
	...
	public class HealingFire : ModBuff
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Healing Fire"); // Buff display name
			Description.SetDefault("Fire heal"); // Buff description
		...
		{
			player.GetModPlayer<HealingFireDebuff>().lifeRegenDebuff = true;
		}
	}

	public class HealingFireDebuff : ModPlayer
	{
