...
namespace TheCollectors.Tiles.Trees
{
    class TinTreeSapling : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.AnchorValidTiles = new[] { ModContent.TileType<Items.NPCStash.Meteorman.TinSoilTile>() };
