...
{
    class CopptinTreeSapling : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.AnchorValidTiles = new int[] { TileID.Copper };
            //TileObjectData.newTile.AnchorValidTiles = new int[] { TileID.Tin };
            //TileObjectData.newTile.AnchorValidTiles = new[] { ModContent.TileType<ShroomiteOre>(), TileID.Chlorophyte};
            //TileObjectData.newTile.AnchorValidTiles = new[] { ModContent.TileType<ExampleBlock>() , TileID.Gold };
            //TileObjectData.newTile.AnchorValidTiles = new[] { ModContent.ItemType<Items.Placeable.MeteormanStash.ShroomiteAcorn>()};
            //TileObjectData.newTile.AnchorValidTiles = new[] { ModContent.TileType<ShroomiteOre>()};
            ...
            name.SetDefault("Copptin Sapling");
