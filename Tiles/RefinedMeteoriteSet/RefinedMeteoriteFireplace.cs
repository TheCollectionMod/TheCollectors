...
namespace TheCollectors.Tiles.RefinedMeteoriteSet
{
	public class RefinedMeteoriteFireplace : ModTile
	{
		...
		{
			Terraria.Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 32, ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteFireplace>());
		}
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteFireplace>();
		}
