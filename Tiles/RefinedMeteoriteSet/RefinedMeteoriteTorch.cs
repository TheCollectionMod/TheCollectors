...
namespace TheCollectors.Tiles.RefinedMeteoriteSet
{
	public class RefinedMeteoriteTorch : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			ItemDrop = ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteTorch>();
			...
			if (!Main.dedServ)
			{
				flameTexture = ModContent.Request<Texture2D>("TheCollectors/Tiles/RefinedMeteoriteSet/RefinedMeteoriteTorch_Flame");
			}
		}
