...
namespace TheCollectors.Tiles.RefinedMeteoriteSet
{
	...
	internal class RefinedMeteoriteCandle : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			ItemDrop = ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteCandle>();
			...
			if (!Main.dedServ)
			{
				flameTexture = ModContent.Request<Texture2D>("TheCollectors/Tiles/RefinedMeteoriteSet/RefinedMeteoriteCandle_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
			}
		}
		...
		{
			if (!fail && !noItem)
				Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteCandle>());
		}*/
