...
namespace TheCollectors.Tiles.RefinedMeteoriteSet
{
	internal class RefinedMeteoriteCampfire : ModTile
	{
		...
		{
			Terraria.Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 32, ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteCampfire>());
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteCampfire>();
		}
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Texture2D glowmask = ModContent.Request<Texture2D>("TheCollectors/Tiles/RefinedMeteoriteSet/RefinedMeteoriteCampfire_Flame").Value;
...
/*{
	...
	public override void SetStaticDefaults()
	{
		...
		if (!Main.dedServ)
		{
			flameTexture = ModContent.Request<Texture2D>("TheCollectors/Tiles/RefinedMeteoriteSet/RefinedMeteoriteCampfirev2_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
		}
	}

	public override void KillMultiTile(int i, int j, int frameX, int frameY)
	{
		Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32,16, ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteCampfirev2>());
	}
