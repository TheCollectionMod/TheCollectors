...
namespace TheCollectors.Tiles.RefinedMeteoriteSet
{
	public class RefinedMeteoriteCraftingStation : ModTile
	{
		...
		{
			Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 64, 48, ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteCraftingStation>());
		}
