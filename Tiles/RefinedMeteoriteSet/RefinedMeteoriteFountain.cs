...
namespace TheCollectors.Tiles.RefinedMeteoriteSet
{
    public class RefinedMeteoriteFountain : ModTile
    {
        ...
        {
            Terraria.Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteFountain>());
        }
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteFountain>();
        }
