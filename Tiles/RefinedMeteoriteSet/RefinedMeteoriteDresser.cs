...
{
	public class RefinedMeteoriteDresser : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			DresserDrop = ModContent.ItemType<Items.Placeable.RefinedMeteoriteSet.RefinedMeteoriteDresser>();

			// Names
			AddToArray(ref TileID.Sets.RoomNeeds.CountsAsTable);
			ModTranslation name = CreateMapEntryName();
			name.SetDefault("Refined Meteorite Dresser");
			AddMapEntry(new Color(200, 200, 200), name);
			ContainerName.SetDefault("Refined Meteorite Dresser");
