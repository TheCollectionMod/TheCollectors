...
namespace TheCollectors.Items.Weapons.Throwing
{
    public class BrainShuriken : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Maindo shuriken");
            Tooltip.SetDefault("Now with built-in mind control!");
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = Item.sellPrice(0, 0, 0, 27);
            ...
            Item.shoot = ModContent.ProjectileType<Projectiles.Throwing.BrainShuriken>();
        }
    }
}
