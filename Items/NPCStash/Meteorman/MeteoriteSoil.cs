...
{
	public class MeteoriteSoil : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Meteorite Soil");
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Items.NPCStash.Meteorman.MeteoriteSoilTile>();
	...
	public class MeteoriteSoilTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Meteorite Soil");
			AddMapEntry(new Color(207, 170, 216), name);

			DustType = DustID.Meteorite;
			ItemDrop = ModContent.ItemType<Items.NPCStash.Meteorman.MeteoriteSoil>();
