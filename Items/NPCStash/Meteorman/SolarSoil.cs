...
{
	public class SolarSoil : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Solar Soil");
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Items.NPCStash.Meteorman.SolarSoilTile>();
	...
	public class SolarSoilTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Solar Soil");
			AddMapEntry(new Color(161, 172, 173), name); //revisar

			DustType = DustID.LunarOre;
			ItemDrop = ModContent.ItemType<Items.NPCStash.Meteorman.SolarSoil>();
