...
{
	public class VortexSoil : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Vortex Soil");
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Items.NPCStash.Meteorman.VortexSoilTile>();
	...
	public class VortexSoilTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Vortex Soil");
			AddMapEntry(new Color(161, 172, 173), name); //revisar

			DustType = DustID.LunarOre;
			ItemDrop = ModContent.ItemType<Items.NPCStash.Meteorman.VortexSoil>();
