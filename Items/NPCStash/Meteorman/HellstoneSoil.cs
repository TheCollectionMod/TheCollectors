...
{
	public class HellstoneSoil : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Hellstone Soil");
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Items.NPCStash.Meteorman.HellstoneSoilTile>();
	...
	public class HellstoneSoilTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Hellstone Soil");
			AddMapEntry(new Color(238, 102, 70), name);

			DustType = DustID.GoldFlame;
			ItemDrop = ModContent.ItemType<Items.NPCStash.Meteorman.HellstoneSoil>();
