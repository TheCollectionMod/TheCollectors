...
{
	public class LuminiteSoil : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Luminite Soil");
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Items.NPCStash.Meteorman.LuminiteSoilTile>();
	...
	public class LuminiteSoilTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Luminite Soil");
			AddMapEntry(new Color(94, 229, 163), name);

			DustType = DustID.LunarOre;
			ItemDrop = ModContent.ItemType<Items.NPCStash.Meteorman.LuminiteSoil>();
