...
{
	public class CobaltSoil : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cobalt Soil");
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Items.NPCStash.Meteorman.CobaltSoilTile>();
	...
	public class CobaltSoilTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Cobalt Soil");
			AddMapEntry(new Color(37, 118, 171), name);

			DustType = DustID.Cobalt;
			ItemDrop = ModContent.ItemType<Items.NPCStash.Meteorman.CobaltSoil>();
