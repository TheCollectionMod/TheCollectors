...
namespace TheCollectors.Items.NPCStash.Meteorman
{
	public class LeadSoil : ModItem
	{
		...
		{
			DisplayName.SetDefault("Lead Soil");
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Items.NPCStash.Meteorman.LeadSoilTile>();
	...
	public class LeadSoilTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Lead Soil");
			AddMapEntry(new Color(62, 82, 114), name);

			DustType = DustID.Lead;
			ItemDrop = ModContent.ItemType<Items.NPCStash.Meteorman.LeadSoil>();
