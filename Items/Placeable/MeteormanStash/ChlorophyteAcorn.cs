...
{
	public class ChlorophyteAcorn : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Chlorophyte Acorn");
		...
		public override void SetDefaults()
		{
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Trees.ChlorophyteTreeSapling>());
