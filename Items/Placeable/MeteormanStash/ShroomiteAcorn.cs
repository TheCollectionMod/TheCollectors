...
{
	public class ShroomiteAcorn : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Shroomite Acorn");
		...
		public override void SetDefaults()
		{
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Trees.ShroomiteTreeSapling>());
			//Item.createTile = ModContent.TileType<Tiles.Trees.ShroomiteTreeSapling>();
