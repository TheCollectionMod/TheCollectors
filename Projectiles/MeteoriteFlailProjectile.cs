...
namespace TheCollectors.Projectiles
{
	...
	{
		private const string ChainTexturePath = "TheCollectors/Projectiles/MeteoriteFlailProjectileChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "TheCollectors/Projectiles/MeteoriteFlailProjectileChainExtra";  // This texture and related code is optional and used for a unique effect
