...
namespace TheCollectors.Projectiles.Magic
{
	public class DiamondBoltTier2 : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			int healingAmount = damage / 10; //decrease the value 30 to increase heal, increase value to decrease. Or you can just replace damage/x with a set value to heal, instead of making it based on damage.
