...
{
    public class BobberMeteorite : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Meteorite Bobber");
        }
...
/*public class BobberMeteorite : ModProjectile
	{
        ...
        public override bool PreDrawExtras(SpriteBatch spriteBatch)      //this draws the fishing line correctly
        {
            ...
            if (Projectile.bobber && Main.player[Projectile.owner].inventory[Main.player[Projectile.owner].selectedItem].holdStyle > 0)
            {
                ...
                if (type == mod.ItemType("MeteoriteFishingPole")) //add your Fishing Pole name here
                {
                ...
                while (flag2)
                {
                    ...
                    else
                    {
                        ...
                        Microsoft.Xna.Framework.Color color2 = Lighting.GetColor((int)value.X / 16, (int)(value.Y / 16f), new Microsoft.Xna.Framework.Color(254, 121, 2));    //this is the fishing line color in RGB, 200 is red, 12 is green, 50 blue
